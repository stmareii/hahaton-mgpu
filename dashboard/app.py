"""
Главная страница дашборда. Запуск: streamlit run app.py
Многостраничное приложение - остальные страницы в папке pages/.
"""
...
with right:
    ...
    # сортируем как числа, но оставляем строки
...
st.info(
    "В левом меню: **Нарушения частоты**, **Аномалии**, **Детали / Выгрузка**."
)
